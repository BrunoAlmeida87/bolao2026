...
**Gráfico de evolução:** bump chart (SVG) com linhas curvas mostrando a trajetória de posição de cada participante **por dia** (cada dia com resultado vira um ponto no eixo X). A linha dourada destaca o líder atual.
